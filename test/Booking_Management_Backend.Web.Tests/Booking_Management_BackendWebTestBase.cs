...
{
    public abstract class Booking_Management_BackendWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static Booking_Management_BackendWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(Booking_Management_BackendWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<Booking_Management_BackendDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<Booking_Management_BackendDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<Booking_Management_BackendDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<Booking_Management_BackendDbContext, Task<T>> func)
        {
            T result;
