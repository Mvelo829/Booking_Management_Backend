...
namespace Booking_Management_Backend.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = Booking_Management_BackendConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(Booking_Management_BackendDbContext context)
        {
            _context = context;
        }
